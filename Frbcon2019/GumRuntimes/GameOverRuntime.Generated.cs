    ...
    {
        public partial class GameOverRuntime : Gum.Wireframe.GraphicalUiElement
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            TextInstance1.YUnits = Gum.Converters.GeneralUnitType.PixelsFromSmall;
                            FinalScoreValue.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "ContainerInstance");
                            FinalScoreValue.Text = "Hello";
                            break;
                    }
                }
            }
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        if (interpolationValue < 1)
                        {
                            this.FinalScoreValue.Text = "Hello";
                        }
                        if (interpolationValue < 1)
                        {
                        ...
                        if (interpolationValue < 1)
                        {
                            this.TextInstance1.YUnits = Gum.Converters.GeneralUnitType.PixelsFromSmall;
                        }
                        break;
                }
                switch(secondState)
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Frbcon2019.GumRuntimes.GameOverRuntime.VariableState fromState,Frbcon2019.GumRuntimes.GameOverRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
            {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        {
                            SetsValue = true,
                            Name = "FinalScoreValue.Text",
                            Type = "string",
                            Value = FinalScoreValue.Text
                        }
                        );
                        break;
                }
            ...
            public GameOverRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            {
                if (fullInstantiation)
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Screens.First(item => item.Name == "GameOver");
