    ...
    {
        public partial class TestRuntime : Gum.Wireframe.GraphicalUiElement
        {
            #region State Enums
            ...
            public TestRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Screens.First(item => item.Name == "Test");
