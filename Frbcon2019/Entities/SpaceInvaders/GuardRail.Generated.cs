...
{
    public partial class GuardRail : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public GuardRail (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public GuardRail (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            AxisAlignedRectangleInstance.Height = 1000f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("GuardRailStaticUnload", UnloadStaticContent);
